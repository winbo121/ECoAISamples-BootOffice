...
function fnSave() {
	...
	if(document.detailForm.mode.value == "insert") {
		document.detailForm.action = "<c:url value='/pattern/p32/insertEmployee.do'/>";
	}else{
		document.detailForm.action = "<c:url value='/pattern/p32/updateEmployee.do'/>";
	}
	document.detailForm.submit();
}
function fnRetrieveList() {
	document.detailForm.action = "<c:url value='/pattern/p32/retrieveEmployeeList.do'/>";
	document.detailForm.submit();
}
