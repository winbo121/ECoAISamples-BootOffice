...
function fnSave() {
	...
	if(document.detailForm.mode.value == "insert") {
		document.detailForm.action = "<c:url value='/pattern/pp3/insertEmployee.do'/>";
	}else{
		document.detailForm.action = "<c:url value='/pattern/pp3/updateEmployee.do'/>";
	}
...
function fnRetrieveList() {
	...
	document.detailForm.action = "<c:url value='/pattern/pp3/retrieveEmployeeList.do'/>";
	document.detailForm.submit();
}
