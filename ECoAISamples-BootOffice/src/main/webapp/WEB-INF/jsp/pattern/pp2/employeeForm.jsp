...
function fnSave() {
	...
	if(document.detailForm.mode.value == "insert") {
		document.detailForm.action = "<c:url value='/pattern/pp2/insertEmployee.do'/>";
	}else{
		document.detailForm.action = "<c:url value='/pattern/pp2/updateEmployee.do'/>";
	}
...
function fnRetrieveList() {
	...
	document.detailForm.action = "<c:url value='/pattern/pp2/retrieveEmployeeList.do'/>";
	document.detailForm.submit();
}
...
<div id="LblockBody">
	<div id="LblockPageHeader">
		...
		<div id="LblockPageLocation">
			<ul>
				...
				<li class="Llast"><span>PP2 Ajax Page</span></li>
			</ul>
		</div>
	</div>
	...
	<div id="LblockBodyMain">
		<div id="LblockDetail01" class="LblockDetail">
			<form:form modelAttribute="result" name="detailForm" method="post" onsubmit="fnRetrieveList();return false;">
