...
public class ScrollPagingEmployee extends ScrollPagingEntity{
    ...
    private String searchJoblevelCode;
    ...
    public String getSearchSkillCode() {
        return searchSkillCode;
    }


    
    public void setSearchSkillCode(String searchSkillCode) {
        this.searchSkillCode = searchSkillCode;
    }


    
    public String getSearchJoblevelCode() {
        return searchJoblevelCode;
    }


    
    public void setSearchJoblevelCode(String searchJoblevelCode) {
        this.searchJoblevelCode = searchJoblevelCode;
    }
